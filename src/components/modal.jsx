            ...
            <div className={`relative z-50 ${props.openModal ? 'block' : 'hidden'}`} aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        <div className={`relative transform overflow-hidden rounded-lg bg-lnk-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl`}>
                            ...
                            <div className="bg-lnk-white border-t border-lnk-gray px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button onClick={props.handleSubmit} type="button" className="inline-flex w-full justify-center rounded bg-lnk-dark-gray px-3 py-2 text-sm font-semibold text-lnk-white shadow-sm hover:bg-opacity-80 sm:ml-3 sm:w-auto">Save</button>
