const LnkInput = ({ type, placeholder, label, className }) => {
    return (
        <div className={className}>
            ...
            <input type={type} id={label.toLowerCase().replace(' ', '-')} placeholder={placeholder} className=" px-3 py-2 w-full rounded border border-lnk-gray text-sm outline-none focus:outline focus:outline-lnk-orange " />
        </div>
    )
}
